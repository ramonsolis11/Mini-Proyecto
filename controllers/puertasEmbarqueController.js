...
const obtenerPuertasEmbarque = (req, res) => {
    // Obtener las puertas de embarque desde una fuente de datos
    const puertasEmbarque = [
        ...
        { numero: 'C1', disponible: true, avionAsignado: null },
        { numero: 'C2', disponible: false, avionAsignado: { registro: 'EF789', aerolinea: 'Airline 3' } },
